...
public class ServerSetting {
    ...
    static {
        ...
        errorActionMap.put(SLASH, new DefaultIndexAction());
    ...
    public static void setRoot(String root) {
        ...
        ServerSetting.root = path.toFile();
    ...
    public static void setRoot(File root) {
        if (root.exists() == false) {
            ...
            throw new IllegalStateException("root path error: " + root.getPath());
        }
    ...
    public static void setFilter(String path, Filter filter) {
        ...
        //所有路径必须以 "/" 开头，如果没有则补全之
        if (false == path.startsWith(SLASH)) {
            path = SLASH + path;
        }
