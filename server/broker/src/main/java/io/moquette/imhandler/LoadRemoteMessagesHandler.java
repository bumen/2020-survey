...
public class LoadRemoteMessagesHandler extends IMHandler<WFCMessage.LoadRemoteMessages> {
    @Override
    public ErrorCode action(ByteBuf ackPayload, String clientID, String fromUser, String section,  boolean isAdmin, WFCMessage.LoadRemoteMessages request, Qos1PublishHandler.IMCallback callback) {
