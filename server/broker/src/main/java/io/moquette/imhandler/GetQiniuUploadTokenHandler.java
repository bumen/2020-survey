...
public class GetQiniuUploadTokenHandler extends IMHandler<Byte> {
    @Override
    public ErrorCode action(ByteBuf ackPayload, String clientID, String fromUser, String section, boolean isAdmin, Byte request, Qos1PublishHandler.IMCallback callback) {
        int type = request;
        String token;
